...
PORT="${PORT:-5850}"
DB_NAME="${PGDATABASE:-personal_finance_consumer_suite_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Personal Finance Consumer Suite Suite"
echo "======================================="
echo
...
echo "Starting personal finance consumer suite suite frontend on http://localhost:$PORT"
echo "Login: admin@personal-finance-consumer-suite.local / admin123"
