...
export default function LoginPage() {
  ...
  const onSubmit = async (event: FormEvent) => {
    ...
    setSubmitting(false);
    if (!ok) {
      setError('Use the seeded personal finance consumer suite suite demo credentials.');
      return;
    }
  ...
  return (
    <div className="auth-wrap">
      <div className="auth-card">
        <div className="pill">Personal Finance Consumer Suite</div>
        <h1 style={{ marginBottom: 8 }}>Unified healthcare login</h1>
        <div className="muted">
          One login for personal finance consumer suite features, documents, notifications, audit, approvals, and AI operations.
        </div>
