export const AUTH_COOKIE = 'personal_finance_consumer_suite_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@personal-finance-consumer-suite.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@personal-finance-consumer-suite.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@personal-finance-consumer-suite.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
