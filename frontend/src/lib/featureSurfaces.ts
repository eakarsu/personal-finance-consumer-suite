...
const featureSeeds = [
  ...
  ["budget-coach","Budget Coach","Budget Coach review queue","Financial Planning Coach","Review source context and assign owner"],
  ["retirement-scenarios","Retirement Scenarios","Retirement Scenarios review queue","Financial Planning Coach","Confirm next action and update evidence"],
  ["cash-flow-planning","Cash Flow Planning","Cash Flow Planning review queue","Financial Planning Coach","Confirm next action and update evidence"],
  ["advisor-report","Advisor Report","Advisor Report review queue","Financial Planning Coach","Confirm next action and update evidence"],
