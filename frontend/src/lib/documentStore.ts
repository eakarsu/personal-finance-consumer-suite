...
const seed: DocumentRecord[] = [
  { id: 'doc-1', name: 'Accounts Packet', type: 'Accounts', owner: 'Finance Lead', status: 'In review', updatedAt: '2026-05-24 10:00' },
  ...
  { id: 'doc-3', name: 'Transactions Evidence Set', type: 'Transactions', owner: 'Governance Lead', status: 'Ready', updatedAt: '2026-05-24 09:35' },
];
