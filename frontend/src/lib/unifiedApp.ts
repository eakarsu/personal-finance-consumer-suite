...
const features = [
  ...
  },
  {
    ...
    title: "Budget Coach",
    href: "/budget-coach",
    category: "Financial Planning Coach",
    icon: FileText,
    summary: "Budget categories, cash-flow review, spending trends, and savings opportunities.",
    bullets: ["Budget","Cash flow","Savings"],
    metrics: [
      { label: "Budget Coach", value: "32", note: 'Active' },
  ...
  },
  {
    ...
    href: "/retirement-scenarios",
    category: "Financial Planning Coach",
    icon: ClipboardList,
    summary: "Retirement goals, assumptions, scenario comparisons, and risk notes.",
    bullets: ["Goals","Scenarios","Risk"],
    metrics: [
      { label: "Retirement Scenarios", value: "45", note: 'Active' },
  ...
  },
  {
    ...
    href: "/cash-flow-planning",
    category: "Financial Planning Coach",
    icon: Activity,
    summary: "Income, expenses, debt, emergency fund, and monthly plan.",
    bullets: ["Income","Expenses","Debt"],
    metrics: [
      { label: "Cash Flow Planning", value: "58", note: 'Active' },
  ...
  },
  {
    ...
    category: "Financial Planning Coach",
    icon: BarChart3,
    summary: "Client-ready summary, recommendations, assumptions, and follow-up questions.",
    bullets: ["Summary","Recommendations","Assumptions"],
    metrics: [
      { label: "Advisor Report", value: "71", note: 'Active' },
...
export const featureFamilies = [
  ...
  { name: 'Financial Planning Coach', features: ["Budget Coach","Retirement Scenarios","Cash Flow Planning","Advisor Report"] },
